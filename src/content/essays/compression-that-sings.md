---
title: 'The Compression That Sings'
...
Figure 1. Three statistical regimes. The sweet spot—1/f—is where music, hydrology, atmospheric turbulence, and biological signals all live.
...
Music that inhabits the manifold is perceived as beautiful because the perceptual system recognizes its structure. Music that departs from it is perceived as either boring (overcompressible, no novelty) or noise (incompressible). Bach, paradigmatically, pushes the manifold to its limit—maximally dense logical depth, fully compressible against a listener's natural priors.

Figure 2. The compressibility manifold. Systems with low Kolmogorov complexity and high logical depth cluster in a common region—short to describe, long to assemble. Music and natural systems inhabit the same region, because both are generated by physical processes operating across scales.
