---
title: "Simple equations . . . simple computations"
...
Building a "machine" to simulate nature and environmental protection efforts

![](/images/posts/simple-equations-simple-computations/img-01.gif)

Simplicity of Simulating Nature

A [calculation](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7itwX_MFKkNfE8klJzPMeZJtBEjpHdLQSvtwXs_80tlkoDXm23Sv0YDDpw7VLZmDVMtlUIGrMZjbwzRCSBO2RjEiW7xCAmF0gm2DvIzyl5Sbduk3qdx6O5CNQWXMa8mAFX&c=&ch=) performed by MIT found that the universe has performed the equivalent of 10120 ops on 1090 bits. The earth's atmosphere contains 1.04 × 1044 molecules. Assuming approximately 4.140×1022atoms in an an average mole of air, and a [full-ci](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7isLsgvNy2hemehhMVGUZUtrzGHebKRVJp1Q2xFz7ncPjGdNQn5fY0kwpU01FwXZo5hlqJ-0V3vng5gpZhU0W77XdHvoM4k-2pe3g9Akssb3bBEvUuMHHWsO--DNDjwXui&c=&ch=) in the range of 1044, that's 10111 computational variables.
...
Let me quickly explain the exponents involved in computing. Let's take for example a very simple 3 bit system. There are 8 possible three-bit combinations: 000, 001, 010, 011, 1000, 101, 110, and 111. That's 23. There are 2 choices for the first bit. 2 choices for the second bit. And 2 choices for the third bit. If instead we use qubits instead of bits, then each of these 8 combinations is associated with a basis vector and so the vector space is 8-dimensional. As the number of qubits grow, the number of basis vectors grows exponentially . . . and gets very very big . . . very very fast. China two days ago created the most powerful quantum computer at [62 qubits](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7iYA6pJY_7Wp6J7qzqaVzn40kfwO0_R6UxZ5tlE8sm7sdhnLaSUfphKY0vwav4KXqIs9F4vGZFKcKBkvY5Yh0zqwSgdBrUdQ-w2QJ8O080rNkWWz2nrz91mzYq-GQVv3uh86Rvum8__svg800le46Ztp6Yc6Yegjn-&c=&ch=). Google has the [54 qubit Sycamore Computer](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7iEok5oMwskOqvUZU6cssuWJ0YicXn0wTqYTSZOFjDznLoo1HO-BNQetiNXyViolIZRPDnTOv8QKGoioxvWFTcyOgBX-48WQrEWliMbmhhUI4OZ68wVFX80g==&c=&ch=). IBM's Quantum Eagle computer slated for later this year is expected to be [127 qubits](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7iCzNigP2Y0eonEutFJLpYpsoKRPmxW0QI7nErIPKfOWFwnpD0ZOUwpxb_L7PQ-XjEMKmTO1DgrLSgLxk2adGbobw5FtEizI01WwYvz2ZjFRsjXUjOBZ8IURBv2XvHxhD2mkb8ByJI5tIp6R1nLNrJOw==&c=&ch=). IBM has also announced its [1,121-qubit Condor device](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7igiPGb28YspmrxN-hflpp99EIUV625PeXUtAVyyXqmS8sknXkrX59S63Mc6S7GVWtcmSpkLvVF_KNHDgSeMjOumZohfkexUYBGt_6PPoYKNMn197oc-RMre9uGvflZdMMgNQ_OtnTooF853J5cTrBAU41Huks4P9TrbjUAQylOu7nHnvbYgyzp_XC_85CHk3d&c=&ch=) planned for 2023. Once a machine reaches 300 qubits, that computer will be using more than the number of elementary particles in the universe as its computational basis. 2300 is a whopping big number of basis elements. Quantum computing will allow us to work back through the complicated phenomena to find more of the simple equations and computational programs that started and still are guiding the phenomena--and allow us to simulate the protection of natural systems. Quantum computing will deal with the exponents.

---"Protecting nature will become very simple."

- Jed Anderson, Creator, EnviroAI

![](/images/posts/simple-equations-simple-computations/img-02.gif)

![](/images/posts/simple-equations-simple-computations/img-03.gif)

Nature = Simple Equations

Mathematical equations that explain nature we are finding are very simple:

![](/images/posts/simple-equations-simple-computations/img-04.png)

![](/images/posts/simple-equations-simple-computations/img-05.gif)
...
[![](/images/posts/simple-equations-simple-computations/img-06.gif)](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-v26vrwLcw7i9Dk_gfpWXgYAmpEO1HujTFr1_95QreLlWjrB9MFYgBJ8LP7wQhLzSoheahHhhLcmwTibYwfx5V4ZsWR4aWizJCVqFzEvXKcx_2OnOEuHCIASK0oU24ewMw==&c=&ch=)

![](/images/posts/simple-equations-simple-computations/img-07.gif)

SIMPLICITY

![](/images/posts/simple-equations-simple-computations/img-08.gif)
...
![](/images/posts/simple-equations-simple-computations/img-09.png)
...
![](/images/posts/simple-equations-simple-computations/img-10.png)
...
![](/images/posts/simple-equations-simple-computations/img-11.png)
...
![](/images/posts/simple-equations-simple-computations/img-12.gif)

![](/images/posts/simple-equations-simple-computations/img-13.gif)

﻿

[![](/images/posts/simple-equations-simple-computations/img-14.png)](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-qU3VwCCa388spWW01HM5Ai_6A4wYypsfPmAJT7wRwwiRb_m5m6J6Nv6auGQgt9WlOYa8BBP-io827on50OJHNEvWLQwAHgrOA==&c=&ch=)

![](/images/posts/simple-equations-simple-computations/img-15.gif)

[More Info](http://r20.rs6.net/tn.jsp?f=001_rRhvMBwe1SnOeadbiFq3GFGLULMC-tpUAOT2qu1cL9vWYCoJzbQ-qU3VwCCa388spWW01HM5Ai_6A4wYypsfPmAJT7wRwwiRb_m5m6J6Nv6auGQgt9WlOYa8BBP-io827on50OJHNEvWLQwAHgrOA==&c=&ch=)

![](/images/posts/simple-equations-simple-computations/img-16.gif)
